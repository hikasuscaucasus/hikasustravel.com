...
const staticPages = [
  ...
  { path: 'embassies/georgia', changefreq: 'monthly', priority: '0.7' },
  { path: 'embassies/armenia', changefreq: 'monthly', priority: '0.7' },
  { path: 'embassies/azerbaijan', changefreq: 'monthly', priority: '0.7' },

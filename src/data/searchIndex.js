...
const STATIC_PAGES = [
  ...
  { path: 'embassies/georgia', seoKey: 'embassiesGeorgia', type: 'info' },
  { path: 'embassies/armenia', seoKey: 'embassiesArmenia', type: 'info' },
  { path: 'embassies/azerbaijan', seoKey: 'embassiesAzerbaijan', type: 'info' },
